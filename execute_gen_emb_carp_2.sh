...
# python run_pregen_emb.py --dataset_path="data/structure/secondary_structure/tape_processed.csv" --encoder_name="carp_76M" --subset_list='["train","val","cb513","ts115","casp12"]' --checkpoint=1 --reset_param=True
# python run_pregen_emb.py --dataset_path="data/structure/secondary_structure/tape_processed.csv" --encoder_name="carp_76M" --subset_list='["train","val","cb513","ts115","casp12"]' --checkpoint=1 --resample_param=True
# python run_pregen_emb.py --dataset_path="data/structure/secondary_structure/tape_processed.csv" --encoder_name="carp_76M" --subset_list='["train","val","cb513","ts115","casp12"]' --checkpoint=1
# python run_pregen_emb.py --dataset_path="data/structure/secondary_structure/tape_processed.csv" --encoder_name="carp_76M" --subset_list='["train","val","cb513","ts115","casp12"]' --checkpoint=0.5
# python run_pregen_emb.py --dataset_path="data/structure/secondary_structure/tape_processed.csv" --encoder_name="carp_76M" --subset_list='["train","val","cb513","ts115","casp12"]' --checkpoint=0.25
# python run_pregen_emb.py --dataset_path="data/structure/secondary_structure/tape_processed.csv" --encoder_name="carp_76M" --subset_list='["train","val","cb513","ts115","casp12"]' --checkpoint=0.125

# python run_pregen_emb.py --dataset_path="data/structure/secondary_structure/tape_processed.csv" --encoder_name="carp_640M" --subset_list='["train","val","cb513","ts115","casp12"]' --checkpoint=1 --reset_param=True
# python run_pregen_emb.py --dataset_path="data/structure/secondary_structure/tape_processed.csv" --encoder_name="carp_640M" --subset_list='["train","val","cb513","ts115","casp12"]' --checkpoint=1 --resample_param=True
# python run_pregen_emb.py --dataset_path="data/structure/secondary_structure/tape_processed.csv" --encoder_name="carp_640M" --subset_list='["train","val","cb513","ts115","casp12"]' --checkpoint=1
# python run_pregen_emb.py --dataset_path="data/structure/secondary_structure/tape_processed.csv" --encoder_name="carp_640M" --subset_list='["train","val","cb513","ts115","casp12"]' --checkpoint=0.5
# python run_pregen_emb.py --dataset_path="data/structure/secondary_structure/tape_processed.csv" --encoder_name="carp_640M" --subset_list='["train","val","cb513","ts115","casp12"]' --checkpoint=0.25
# python run_pregen_emb.py --dataset_path="data/structure/secondary_structure/tape_processed.csv" --encoder_name="carp_640M" --subset_list='["train","val","cb513","ts115","casp12"]' --checkpoint=0.125
